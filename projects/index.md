...
[Making my chemical equation balancer better.](/projects/making_my_chemical_equation_balancer_better.html)

[Making minesweeper](/projects/making_minesweeper.html)

[Making a regex engine in python](/projects/implementing_a_regex_engine_in_python.html)

[Implementing AES encryption and adding OCB1 extension on it in python](/projects/implementing_aes_in_python.html)

[Elastic circle collision](/projects/elastic_circle_project.html)

[Graphics library in python](/projects/making_a_graphics_library.html)

[Python interpreter in python (under construction)](/projects/making_a_python_interpreter_in_python.html)

[Programming FAIR minesweeper (no guessing) (under construction)](/projects/making_fair_minesweeper.html)
...
[Fuzzing CSGO packet handler (original).](/projects/fuzzing_csgo.html)

[Fuzzing libmsvg.](/projects/fuzzing_libmsvg.html)

[Fuzzing the CSGO packet handler.](/projects/fuzzing_csgo_packet_handler.html)

[Fuzzing ruby dateformats.](/projects/fuzzing_ruby_dateformats.html)

[Fuzzing nasm (to come)](/projects/fuzzing_nasm.html)

[Testing all of the ruby regexes in the ruby source code.](/projects/making_a_regex_testing_tool_for_ruby_source_code.html)

[Fuzzing BSP maps in CSGO](/projects/fuzzing_bsp_maps.html)

[Fuzzing tinyexpr](/projects/fuzzing_tinyexpr.html)

[Fuzzing the speedcrunch calculator](/projects/fuzzing_speedcrunch.html)
...
[Improving a google oss-fuzz harness (unsuccesful)](/projects/improving_a_google_oss_fuzz_harness.html)
